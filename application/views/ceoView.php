...
<head>
    ...
    <title>Suropriyo Das - Founder & CEO | Suropriyo Enterprise</title>
                ...
                <div class="col-lg-8">
                    <div class="hero-content text-center text-lg-start">
                        ...
                        <div
                            ...
                            <a href="mailto:suropriyo@gmail.com" class="btn btn-ceo-primary btn-lg px-5 py-3">
                                <i class="fas fa-envelope me-2"></i>Let's Connect
                            </a>
                            <a href="<?= base_url() ?>index.php/welcome/Contactus#contactform" class="btn btn-ceo-secondary btn-lg px-5 py-3">
